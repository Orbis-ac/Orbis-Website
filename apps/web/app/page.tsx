    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.title}>The place for Hytale</h1>
          <p className={styles.subtitle}>
            Discover, play, and share Hytale content through our open-source
            platform built for the community.
          </p>
          <div className={styles.heroCta}>
            <button className={styles.primaryButton}>Discover Mods</button>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.featureGrid}>
            ...
            <div className={styles.featureCard}>
              ...
              <p className={styles.featureText}>
                Orbis&apos;s open-source API lets launchers add deep integration.
                Use Orbis through our own app and popular launchers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.creatorFeatures}>
            ...
            <div className={styles.creatorFeature}>
              ...
              <p className={styles.creatorFeatureText}>
                Integrate with your build tools for automatic uploads right
