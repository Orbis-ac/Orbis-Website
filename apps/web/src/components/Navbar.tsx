...
const marketplaceCategories = [
  ...
  {
    name: 'Asset Packs',
    href: '/marketplace/asset-packs',
    icon: 'mdi:image-multiple',
  },
  {
    name: 'Premade Servers',
    href: '/marketplace/premade-servers',
    icon: 'mdi:server',
  },
  ...
  {
    name: 'Tools & Scripts',
    href: '/marketplace/tools-scripts',
    icon: 'mdi:tools',
  },
];
        ...
        <div className="flex max-w-6xl justify-between w-full items-center gap-2">
          ...
          <div className="flex items-center gap-8 font-hebden text-base text-foreground">
            <NavigationMenu delayDuration={50}>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="font-hebden font-semibold text-base leading-none bg-transparent text-foreground hover:text-foreground">
                    Marketplace
                  </NavigationMenuTrigger>
                  <NavigationMenuContent className="grid grid-cols-2 gap-2 bg-accent border border-border rounded-[25px] p-4 min-w-[420px]">
            ...
            <Button variant="ghost">
              <Link
                href="/servers"
                className="font-hebden font-semibold text-base leading-none"
              >
                Server Discovery
              </Link>
            </Button>
          ...
          {session?.user ? (
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center gap-3 outline-none group">
                <Avatar className="h-11 w-11 border-2 border-primary/80 hover:border-primary transition-colors">
                  <AvatarImage
            ...
            <Button className="rounded-full hover:shadow-[0_4px_12px_rgba(16,158,177,0.3)] flex h-11 w-[130px] bg-primary/80 font-hebden text-base text-white data-active:bg-primary hover:bg-primary transition-all cursor-pointer">
              <Link
                href="/login"
            ...
            <div className="flex-1 px-6 py-6 space-y-6 overflow-y-auto">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <span className="font-hebden font-medium text-foreground">
                    Profile
                  </span>
                </Link>
